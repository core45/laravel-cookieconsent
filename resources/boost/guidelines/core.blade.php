...
- Always activate the `cookieconsent-development` skill when working with cookie banners, consent categories, GDPR script gating, the `@cookieconsent`/`@cookiescript`/`@consent`/`@cookiepreferences`/`@iframe` Blade directives, the `CookieConsent` facade, the `consent:*` middleware, or the `consent_logs` audit trail.
