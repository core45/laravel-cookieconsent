...
Standard Laravel lang files at `lang/vendor/cookieconsent/{locale}/cookieconsent.php` (maps onto orestbida's `language.translations.{locale}` shape: `consentModal`, `preferencesModal`, ...) and `iframemanager.php` (per-service `loadBtn`/`notice`/... strings). Ships `bg`, `cs`, `de`, `el`, `en`, `es`, `et`, `fi`, `fr`, `hr`, `hu`, `it`, `lt`, `lv`, `nl`, `pl`, `pt`, `sk`, `sl`, `sq`, `sv`, `uk`.
